    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">
          QR kod okutma ve giriş kontrol ayarları
        </p>
      </div>
        ...
        <label className="flex items-center justify-between p-4 bg-slate-700 rounded-lg cursor-pointer">
          <div>
            ...
            <p className="text-sm text-slate-400">
              QR okutulduğunda otomatik giriş yap
            </p>
          </div>
          <input
            type="checkbox"
            ...
            onChange={(e) =>
              setLocalSettings({
                ...localSettings,
                autoCheckInEnabled: e.target.checked,
              })
            }
        ...
        <label className="flex items-center justify-between p-4 bg-slate-700 rounded-lg cursor-pointer">
          ...
          <input
            ...
            onChange={(e) =>
              setLocalSettings({
                ...localSettings,
                checkInSoundEnabled: e.target.checked,
              })
            }
            className="w-5 h-5 rounded bg-slate-600 border-slate-500"
          />
        ...
        <label className="flex items-center justify-between p-4 bg-slate-700 rounded-lg cursor-pointer">
          ...
          <input
            ...
            onChange={(e) =>
              setLocalSettings({
                ...localSettings,
                showTableDirections: e.target.checked,
              })
            }
            className="w-5 h-5 rounded bg-slate-600 border-slate-500"
          />
