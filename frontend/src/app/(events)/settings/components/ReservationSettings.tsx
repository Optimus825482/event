    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">
          Rezervasyon kuralları ve zorunlu alanlar
        </p>
      </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setLocalSettings({
                ...localSettings,
                defaultGuestCount: Number(e.target.value),
              })
            }
            min={1}
            max={20}
        ...
        <div className="space-y-3">
          <label className="flex items-center justify-between p-4 bg-slate-700 rounded-lg cursor-pointer">
            <div>
              ...
              <p className="text-sm text-slate-400">
                Masa kapasitesinin üzerinde rezervasyon
              </p>
            </div>
            <input
              type="checkbox"
          ...
          <label className="flex items-center justify-between p-4 bg-slate-700 rounded-lg cursor-pointer">
            <div>
              ...
              <p className="text-sm text-slate-400">
                Rezervasyonda telefon numarası şart
              </p>
            </div>
            <input
              type="checkbox"
          ...
          <label className="flex items-center justify-between p-4 bg-slate-700 rounded-lg cursor-pointer">
            <div>
              ...
              <p className="text-sm text-slate-400">
                Rezervasyonda e-posta adresi şart
              </p>
            </div>
            <input
              type="checkbox"
